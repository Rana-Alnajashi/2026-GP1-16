//
//  BLEConnectionFlowView.swift
//  Nafas
//  Multi-step coordinator: Instructions → Scan → Connect → WiFi → Success
//
...
enum BLEFlowStep {
    case instructions
    case scanning        // scanning animation + device list
    case connecting      // brief connecting overlay
    case wifiInput       // WiFi credentials form
                        ...
                        Group {
                            ...
                            case .scanning:
                                ...
                                .onChange(of: viewModel.state) { _, newState in
                                    // If scan ended with no devices, surface error inline
